...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-learnly-gray">
      <Navbar />
      <main>
        <Hero />
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-learnly-light rounded-lg p-8">
            ...
            <div className="bg-learnly-purple rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-4 text-white">Educators</h3>
